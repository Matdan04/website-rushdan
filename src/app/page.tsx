...
import hrPortal from "@/assets/images/jcorp-hr-portal.png";
import adminIntelligence from "@/assets/images/jcorp-admin-intelligence.png";
import learningDevelopment from "@/assets/images/jcorp-learning-development.png";
import kitaJlandAdmin from "@/assets/images/kita-jland-admin.png";

type Project = { company:string; year:string; title:string; summary:string; image:StaticImageData; link?:string; tags:string[] };
const projects:Project[]=[
  {company:"Hatchlabs · Johor Land Group",year:"2026",title:"KITA Resident & Property Platform",summary:"The backend and administration platform for JLand’s smart-living super-app—connecting homeowners and residents with property information, defect and DLP workflows, appointments, handovers, visitors, community services, retail, loyalty, healthcare, and emergency support.",image:kitaJlandAdmin,tags:["Java 21","Spring Boot","PostgreSQL","Flyway","JWT","Thymeleaf"]},
  {company:"Hatchlabs · JCORP",year:"2026",title:"JCORP HR Portal",summary:"An end-to-end HR operations platform for staff, managers, and administrators—bringing leave, timesheets, claims, approvals, team calendars, employee administration, and reporting into one secure workspace.",image:hrPortal,tags:["Next.js 16","PostgreSQL","Prisma","Entra ID","Azure Blob","Docker"]},
  {company:"Hatchlabs · JCORP",year:"2026",title:"JCORP Admin Intelligence Dashboard",summary:"A multi-source intelligence layer for JCORP’s administration department, designed to connect operational data across OPEX, assets, travel, fleet, services, contracts, complaints, and cost-saving workflows in one decision-ready dashboard.",image:adminIntelligence,tags:["React","Vite","Express","PostgreSQL","Recharts","TanStack Query"]},
  {company:"Hatchlabs · JCORP",year:"2026",title:"JCORP Learning & Development Platform",summary:"A talent-development product replacing manual Excel reporting with connected workflows for programs, registrations, reminders, live attendance, evaluations, business impact, reporting, skills intelligence, learning pathways, IDPs, and employee transcripts.",image:learningDevelopment,tags:["React","Vite","Express","PostgreSQL","Entra ID","Recharts"]},
...
const tools=["JavaScript","TypeScript","Java 21","React 19","Next.js 16","Vite","Node.js","Express","Python","Spring Boot","PostgreSQL","Prisma","Flyway","Redis","Docker","Azure DevOps","Microsoft Entra ID","Azure Blob Storage","TanStack Query","Databricks","Recharts","Vitest","AI Agents"];
const experience=[
  {period:"May 2026 — Present",role:"Senior Full Stack Engineer",company:"Hatchlabs",copy:"Building full-stack, AI-driven systems for JCORP and Johor Land Group, with ownership from requirements to production. Work includes KITA’s resident and property platform, the JCORP HR Portal, a multi-source Admin Intelligence Dashboard, and a connected Learning & Development product—alongside PostgreSQL modernization, secure authentication, Docker infrastructure, CI/CD, and production support.",tags:["Java","Spring Boot","Next.js","React","PostgreSQL","Entra ID","Azure","Docker"]},

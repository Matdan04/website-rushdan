...
const tools=["JavaScript","TypeScript","React 19","Next.js 16","Vite","Node.js","Express","Python","Spring Boot","PostgreSQL","Prisma","Redis","Docker","Azure DevOps","Microsoft Entra ID","Azure Blob Storage","TanStack Query","Databricks","Recharts","AI Agents"];
const experience=[
  {period:"May 2026 — Present",role:"Senior Full Stack Engineer",company:"Hatchlabs",copy:"Building full-stack, AI-driven systems for JCORP and owning delivery from requirements to production. Designed the JCORP HR Portal across leave, timesheet, claims, approval, calendar, and reporting workflows, plus an Admin Intelligence Dashboard that unifies multiple operational data layers for administration leadership. Also leading GitHub Enterprise migrations, PostgreSQL modernization, Docker infrastructure, authentication, CI/CD, and production support.",tags:["Next.js","React","Express","Prisma","PostgreSQL","Entra ID","Azure","Docker"]},

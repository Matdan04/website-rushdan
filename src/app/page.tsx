...
const tools=["JavaScript","TypeScript","React 19","Next.js 16","Vite","Node.js","Express","Python","Spring Boot","PostgreSQL","Prisma","Redis","Docker","Azure DevOps","Microsoft Entra ID","Azure Blob Storage","TanStack Query","Databricks","Recharts","Vitest","AI Agents"];
const experience=[
  {period:"May 2026 — Present",role:"Senior Full Stack Engineer",company:"Hatchlabs",copy:"Building full-stack, AI-driven systems for JCORP and owning delivery from requirements to production. Designed the HR Portal, a multi-source Admin Intelligence Dashboard, and a Learning & Development product that replaces manual Excel reporting with connected talent workflows and analytics. Also leading GitHub Enterprise migrations, PostgreSQL modernization, Docker infrastructure, authentication, CI/CD, and production support.",tags:["Next.js","React","Express","Prisma","PostgreSQL","Entra ID","Azure","Docker"]},

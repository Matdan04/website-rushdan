...
const tools=["JavaScript","TypeScript","React 19","Next.js 16","Node.js","Python","Spring Boot","PostgreSQL","Prisma 7","Docker","Azure DevOps","Microsoft Entra ID","Azure Blob Storage","Databricks","Recharts","AI Agents"];
const experience=[
  {period:"May 2026 — Present",role:"Senior Full Stack Engineer",company:"Hatchlabs",copy:"Building full-stack, AI-driven systems for JCORP and owning delivery from requirements to production. Designed and delivered the JCORP HR Portal across leave, timesheet, claims, approval, calendar, administration, and reporting workflows, alongside GitHub Enterprise migrations, PostgreSQL modernization, Docker infrastructure, REST APIs, authentication, CI/CD, and production support.",tags:["Next.js 16","React 19","Prisma","PostgreSQL","Entra ID","Azure","Docker"]},
